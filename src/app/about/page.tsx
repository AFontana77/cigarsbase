...
export const metadata: Metadata = {
  title: "About Cedro",
  description: "The story behind Cedro. Search 73 cigars from Cigar Aficionado and Halfwheel. Log your smokes. Build your collection.",
};
      ...
      <main id="main-content" className="pt-20">
        <section className="py-20 px-4" style={{ backgroundColor: '#FFF1F2' }}>
          <div className="max-w-2xl mx-auto">
            <h1 className="text-4xl font-bold text-gray-900 mb-6">About Cedro</h1>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Cedro was built for cigar enthusiasts who forget what they liked six months after they smoked it. A $25 cigar deserves better than a half-remembered opinion. Cedro combines a curated database of 73 cigars from Cigar Aficionado and Halfwheel with a personal smoke log so you can find a cigar before you buy it and record your experience before you forget it. The companion app for iPhone and Android adds humidor tracking and curated collections by strength and country. Named for the cedar used in premium cigar boxes — the material that protects and enhances what's inside.
            </p>
            <p className="text-gray-600 leading-relaxed mb-8">
              Cedro is published by Anvil Road LLC, a small product studio building practical apps and reference tools for hobbyists, professionals, and makers. Every product in the portfolio follows the same principle: a curated, searchable database paired with a personal log. Search what the experts know. Record what you discover.
            </p>
