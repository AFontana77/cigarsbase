...
/**
 * Marketing signup for cigarsbase.com.
 *
 ...
 */
const RESOURCE = {
  title: 'Your Cigar Tasting Notes Template',
  blurb: 'Six tasting cards. Brand, vitola, wrapper, draw, burn and flavour by third, with room for a score and whether you would buy it again.',
  url: 'https://www.cigarsbase.com/cigarsbase-cigar-tasting-notes-template.pdf',
};
