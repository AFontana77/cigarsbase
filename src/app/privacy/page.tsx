        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4 space-y-1">
              ...
              <li><strong>Cigar smoke logs you create</strong> — stored locally on your device and, if you have an account, in our secure cloud database (Supabase).</li>
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this policy? Email <a href="mailto:support@cigarsbase.com" className="text-rose-700 hover:underline">support@cigarsbase.com</a>.
            </p>
          </div>
        </section>
      </main>
