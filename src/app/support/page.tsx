          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-rose-50 border border-rose-200 rounded-2xl p-6 mb-10 flex gap-4 items-start">
              <div className="w-10 h-10 rounded-xl bg-rose-100 flex items-center justify-center flex-shrink-0 mt-1">
                <Mail className="text-rose-700" size={20} />
              </div>
              <div>
                ...
                <a href="mailto:support@cigarsbase.com" className="text-rose-700 font-medium hover:underline">support@cigarsbase.com</a>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <details className="border border-gray-200 rounded-xl">
                <summary className="px-6 py-4 font-semibold text-gray-900 cursor-pointer hover:bg-gray-50 rounded-xl list-none flex justify-between items-center">
                  What does the $6.99 unlock include? <span className="text-rose-600 text-lg">+</span>
                </summary>
                <div className="px-6 pb-5 text-gray-600 leading-relaxed">
                  Unlimited smoke logs, humidor tracker, tasting notes, and full library access. One-time payment, no subscription, no expiration.
                </div>
              </details>
              <details className="border border-gray-200 rounded-xl">
                <summary className="px-6 py-4 font-semibold text-gray-900 cursor-pointer hover:bg-gray-50 rounded-xl list-none flex justify-between items-center">
                  How do I restore my purchase? <span className="text-rose-600 text-lg">+</span>
                </summary>
                <div className="px-6 pb-5 text-gray-600 leading-relaxed">
              ...
              <details className="border border-gray-200 rounded-xl">
                <summary className="px-6 py-4 font-semibold text-gray-900 cursor-pointer hover:bg-gray-50 rounded-xl list-none flex justify-between items-center">
                  Does the app require an account? <span className="text-rose-600 text-lg">+</span>
                </summary>
                <div className="px-6 pb-5 text-gray-600 leading-relaxed">
                  No account is required for offline use. An optional free account lets you sync your cigar smoke logs across devices.
                </div>
              </details>
              <details className="border border-gray-200 rounded-xl">
                <summary className="px-6 py-4 font-semibold text-gray-900 cursor-pointer hover:bg-gray-50 rounded-xl list-none flex justify-between items-center">
              ...
              <details className="border border-gray-200 rounded-xl">
                <summary className="px-6 py-4 font-semibold text-gray-900 cursor-pointer hover:bg-gray-50 rounded-xl list-none flex justify-between items-center">
                  How do I delete my account and data? <span className="text-rose-600 text-lg">+</span>
                </summary>
                <div className="px-6 pb-5 text-gray-600 leading-relaxed">
            ...
            <p className="mt-10 text-sm text-gray-400 text-center">
              See our <a href="/privacy" className="text-rose-600 hover:underline">Privacy Policy</a> for information on how we handle your data.
            </p>
          </div>
        </section>
      </main>
