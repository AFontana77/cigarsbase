        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              These Terms of Service govern your use of the CigarsBase cigar collection and smoking log app and the website at cigarsbase.com.
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              Contact: <a href="mailto:support@cigarsbase.com" className="text-amber-800 hover:underline">support@cigarsbase.com</a>
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">2. Use of the Service</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              CigarsBase is a personal cigar collection and smoking log app. You may use the service for personal, non-commercial purposes only.
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              CigarsBase offers a one-time in-app purchase ($6.99 USD) to unlock the full database and premium logging features.
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All content, design, code, and database records in the CigarsBase app and website are owned by Anvil Road LLC
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              CigarsBase is provided "as is" without warranties of any kind. Anvil Road LLC is not liable for any damages
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about these terms? Email <a href="mailto:support@cigarsbase.com" className="text-amber-800 hover:underline">support@cigarsbase.com</a>.
            </p>
          </div>
        </section>
      </main>
